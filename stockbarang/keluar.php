...
$query = "SELECT k.idkeluar, b.namabarang, k.penerima, k.stock, k.tanggal 
          FROM keluar k JOIN barang b ON k.idbarang = b.idbarang";
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <button id="tambahBtn" class="btn btn-primary">Tambah Barang Keluar</button>
                </div>
                <div class="card-body">
                    <table>
                        <thead>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                        ...
                                        <td>{$row['tanggal']}</td>
                                        <td>
                                            <a href='edit_keluar.php?id={$row['idkeluar']}' class='btn btn-warning'>Edit</a>
                                            <a href='hapus_keluar.php?id={$row['idkeluar']}' class='btn btn-danger' onclick=\"return confirm('Yakin ingin menghapus?');\">Hapus</a>
                                        </td>
                                      </tr>";
                                $no++;
                            }
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="proses_keluar.php" class="form-input">
                    ...
                    <div class="form-group">
                        <label for="stock">Jumlah Keluar:</label>
